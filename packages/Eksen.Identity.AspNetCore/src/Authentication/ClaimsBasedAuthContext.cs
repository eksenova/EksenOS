...
internal sealed class ClaimsBasedAuthContext(
...
) : IAuthContext
{
    ...
    public IAuthContextUser? User
    {
        get
        {
            ...
            return principal != null
                ? ClaimsBasedAuthContextUser.FromClaimsPrincipal(principal, identityOptions.Value)
                : null;
        }
    }
    ...
    public IAuthContextTenant? Tenant
    {
        get
        {
            ...
            return principal != null
                ? ClaimsBasedAuthContextTenant.FromClaimsPrincipal(principal)
                : null;
        }
    }
    ...
    public IAuthContextTenant? OriginalTenant
    {
        get
        {
            ...
            return principal != null
                ? ClaimsBasedAuthContextTenant.FromClaimsPrincipal(
                    principal,
                    tenantIdClaimType,
                    tenantNameClaimType)
                : null;
